<li data-crud-id="{{ $branch->id }}" data-parent-id="{{ $branch->parent_id }}" class="mb-1">
    <div
        class="list-group-item d-flex justify-content-between align-items-center p-1 border rounded {{ Bootstrap5::setActiveNav('articles?article_category_id=' . $branch->id) }}">
        @php
            // 자식 중 공개 체크된 것만...
