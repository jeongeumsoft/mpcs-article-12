        ...
        @if (Article::useThumbnail())
            <div data-type="image-upload" class="form-group">
                ...
                <div class="border rounded text-center p-2 my-1 mx-auto" style="max-width: 250px">
                    <img src="" class="w-100 upload-image" data-default-src="{{ Article::noImage() }}"
                        data-crud-edit-name="small_image_url" data-crud-edit-type="image">
                </div>
                ...
                <button type="button" class="btn btn-info align-middle" style="width: 100%" title="">
                    ...
                    {{ trans('mpcs-article::word.choose_a_file') }}
                </button>
            </div>
        @endif
