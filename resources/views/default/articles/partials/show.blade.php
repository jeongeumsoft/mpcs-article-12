<div class="row">
    ...
    <div class="col-12 col-sm">
        <dl class="dl">
            ...
            <dd class="col-8 col-lg-10" data-crud-show-template-id="script-template-article_categories" data-crud-show-type="template-html" data-crud-show-name="article_categories"></dd>
            @if(Article::useTag())
            <dt class="col-4 col-lg-2">{{ Str::title(trans('mpcs-article::word.attr.tags')) }}</dt>
            <dd class="col-8 col-lg-10" data-crud-show-template-id="script-template-tags" data-crud-show-type="template-html" data-crud-show-name="tags"></dd>
            @endif
            ...
            <dd class="col-12 col-lg-10">
                <ul  class="list-group" data-crud-show-template-id="script-template-article_files" data-crud-show-type="template-html" data-crud-show-name="article_files">
                </ul>
            </dd>
        </dl>
    </div>
